...
function KeyIdeaIcon(): ReactNode {
  return (
...
function AdmonitionTypeKeyIdea(props: Parameters<typeof AdmonitionTypeInfo>[0]): ReactNode {
  return (
    <AdmonitionTypeInfo
      {...props}
      icon={<KeyIdeaIcon />}
      title={props.title ?? 'Key Idea'}
    />
  );
}
